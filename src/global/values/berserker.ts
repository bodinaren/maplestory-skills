...
export const AdrenalineRushValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const DarkAuraValues = {
  minLevel: 1,
  maxLevel: 1,
};

export const DarkBreakerValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const GreatswordMasteryValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const GroundBreakerValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const InhumanEnduranceValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const IntimidationValues = {
  minLevel: 0,
  maxLevel: 10,
...
export const RagingSlashValues = {
  minLevel: 1,
  maxLevel: 10,
  levelRequirement: [0, 0, 12, 14, 16, 18, 20, 22, 24, 26, 28],
...
export const WarriorsInstinctValues = {
  minLevel: 0,
  maxLevel: 10,
