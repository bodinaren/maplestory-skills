...
export const BulletSpray: ISkill = {
  name: "Bullet Spray",
  attr: "bullet-spray",
  prop: "bulletSpray",
  rank: 1,
...
export const GatlingFire: ISkill = {
  name: "Gatling Fire",
  attr: "gatling-fire",
  prop: "gatlingFire",
  rank: 1,
...
export const AdvancedBullets: ISkill = {
...
export const MagneticBomb: ISkill = {
  name: "Magnetic Bomb",
  attr: "magnetic-bomb",
  prop: "magneticBomb",
  rank: 1,
...
export const ElectricBlast: ISkill = {
  name: "Electric Blast",
  attr: "electric-blast",
  prop: "electricBlast",
  rank: 1,
...
export const AdvancedPulseWeapons: ISkill = {
...
export const BlastChargeKit: ISkill = {
  name: "BlastChargeKit",
...
export const RocketLauncher: ISkill = {
...
export const HomingMissiles: ISkill = {
...
export const AdvancedMissiles: ISkill = {
...
export const StunGrenades: ISkill = {
  name: "Stun Grenades",
  attr: "stun-grenades",
  prop: "stunGrenades",
  rank: 1,
...
export const SuborbitalBombardment: ISkill = {
