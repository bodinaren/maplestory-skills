...
export const SoaringOrb: ISkill = {
  name: "Soaring Orb",
  attr: "soaring-orb",
  prop: "soaringOrb",
  row: 1,
...
export const RadiantSalvo: ISkill = {
  name: "Radiant Salvo",
  attr: "radiant-salvo",
  prop: "radiantSalvo",
  row: 2,
...
export const ExpansionBlast: ISkill = {
...
export const ConcussionOrb: ISkill = {
  name: "Concussion Orb",
  attr: "concussion-orb",
  prop: "concussionOrb",
  row: 6,
...
export const RagingTempest: ISkill = {
  name: "Raging Tempest",
  attr: "raging-tempest",
  prop: "ragingTempest",
  row: 3,
...
export const EnergySurge: ISkill = {
  name: "Energy Surge",
  attr: "energy-surge",
  prop: "energySurge",
  row: 4,
...
export const StaticFlash: ISkill = {
  name: "Static Flash",
  attr: "static-flash",
  prop: "staticFlash",
  row: 5,
...
export const LightBarrier: ISkill = {
  name: "Light Barrier",
  attr: "light-barrier",
  prop: "lightBarrier",
  row: 3,
...
export const HealingBond: ISkill = {
  name: "Healing Bond",
  attr: "healing-bond",
  prop: "healingBond",
  row: 4,
...
export const FountOfRenewal: ISkill = {
...
export const NarubashanUnleashed: ISkill = {
