...
export const MaharPunch: ISkill = {
  name: "Mahar Punch",
  attr: "mahar-punch",
  prop: "maharPunch",
  rank: 1,
...
export const FistsOfFury: ISkill = {
  name: "Fists of Fury",
  attr: "fists-of-fury",
  prop: "fistsOfFury",
  rank: 1,
...
export const MagnumBlow: ISkill = {
  name: "Magnum Blow",
  attr: "magnum-blow",
  prop: "magnumBlow",
  rank: 1,
...
export const PowerPuncher: ISkill = {
  name: "Power Puncher",
  attr: "power-puncher",
  prop: "powerPuncher",
  rank: 1,
...
export const GiganticBurst: ISkill = {
  name: "Gigantic Burst",
  attr: "gigantic-burst",
  prop: "giganticBurst",
  rank: 1,
...
export const RisingKick: ISkill = {
  name: "Rising Kick",
  attr: "rising-kick",
  prop: "risingKick",
  rank: 1,
...
export const HurricaneCutter: ISkill = {
...
export const Guillotine: ISkill = {
  name: "Guillotine",
  attr: "guillotine",
  prop: "guillotine",
  rank: 1,
...
export const KickTechnician: ISkill = {
...
export const DragonKick: ISkill = {
  name: "Dragon Kick",
  attr: "dragon-kick",
  prop: "dragonKick",
  rank: 1,
...
export const PaceControl: ISkill = {
  name: "Pace Control",
  attr: "pace-control",
  prop: "paceControl",
  rank: 1,
...
export const FightingSpirit: ISkill = {
...
export const PatternBreak: ISkill = {
  name: "Pattern Break",
  attr: "pattern-break",
  prop: "patternBreak",
  rank: 1,
