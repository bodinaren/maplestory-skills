...
export class ScourgingWaveComponent {
  ...
  @Prop({ reflectToAttr: true }) private max: number = ScourgingWave.maxLevel;

  getRequirements(): string[] {
    return [
      `Level ${ ScourgingWave.levelRequirement[this.level] }+`,
  ...
  render() {
    return [
      ...
      <ms-skill-overlay heading={ ScourgingWave.name }
                        element="Holy"
                        level={ this.level }
        ...
        <div slot="description">
          ...
          dealing <span>{ ScourgingWave.values.damage[this.level] }%</span> holy damage
