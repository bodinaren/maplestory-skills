...
export class ElectricBlastComponent {
  ...
  @Prop({ reflectToAttr: true }) private max: number = ElectricBlast.maxLevel;

  getRequirements(): string[] {
    return [
      `Level ${ ElectricBlast.levelRequirement[this.level] }+`,
  ...
  render() {
    return [
      ...
      <ms-skill-overlay heading={ ElectricBlast.name }
                        element="Electric"
                        level={ this.level }
        ...
        <div slot="description">
          ...
          dealing <span>{ ElectricBlast.values.stage1[this.level] }%</span> electric damage
          ...
          deal <span>{ ElectricBlast.values.stage2[this.level] }%</span> electric damage <span>2</span> times
          ...
          deal <span>{ ElectricBlast.values.stage3[this.level] }%</span> electric damage <span>3</span> times
