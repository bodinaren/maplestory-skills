...
export const config: Config = {
  ...
  bundles: [
    { components: ["ms-editor", "ms-editor-outlet", "ms-level-control", "ms-archer-editor", "ms-assassin-editor", "ms-berserker-editor", "ms-knight-editor", "ms-priest-editor", "ms-runeblade-editor", "ms-thief-editor", "ms-wizard-editor"] },
