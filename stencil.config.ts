...
export const config: Config = {
  ...
  bundles: [
    { components: ["ms-editor", "ms-editor-outlet", "ms-archer-editor", "ms-assassin-editor", "ms-berserker-editor", "ms-heavy-gunner-editor", "ms-knight-editor", "ms-priest-editor", "ms-runeblade-editor", "ms-thief-editor", "ms-wizard-editor"] },
    ...
    { components: ["ms-chart", "ms-footer", "ms-icon", "ms-skill-overlay", "ms-skill"] },
  ],
  copy: [
