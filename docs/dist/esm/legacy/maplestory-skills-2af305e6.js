...
var _this = this;
var NAMESPACE = 'maplestory-skills';
var win = window;
var doc = document;
var plt = {
    $flags$: 0,
...
var flush = function () {
    ...
    var timeout = plt.$flags$ & 2 /* queueAsync */
...
var attachStyles = function (elm, cmpMeta, mode) {
    var styleId = addStyle((elm.shadowRoot && supportsShadowDom)
        ? elm.shadowRoot
...
var parseClassList = function (value) { return (value == null || value === '') ? [] : value.split(' '); };
...
var renderVdom = function (hostElm, hostRef, cmpMeta, renderFnResults) {
    ...
    renderFnResults.$elm$ = oldVNode.$elm$ = (hostElm.shadowRoot || hostElm);
    {
        ...
        useNativeShadowDom = !!(supportsShadowDom && cmpMeta.$flags$ & 1 /* shadowDomEncapsulation */);
...
var scheduleUpdate = function (elm, hostRef, cmpMeta, isInitialLoad) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 7, , 8]);
                if (!isInitialLoad) return [3 /*break*/, 4];
            ...
            case 4:
                if (!instance.componentWillUpdate) return [3 /*break*/, 6];
    ...
    if (!elm['s-al']) {
        ...
        if (!(hostRef.$flags$ & 512 /* hasLoadedComponent */)) {
            ...
            if (!ancestorComponent) {
                ...
                {
                    setTimeout(function () { return plt.$flags$ |= 2; } /* queueAsync */, 999);
                }
            }
        }
            ...
            if ((memberFlags & 31) || (proxyState && (memberFlags & 32 /* State */))) {
                ...
                Object.defineProperty(Cstr.prototype, memberName, {
                    value: function () {
                        ...
                        var args = arguments;
                        return ref.$onReadyPromise$.then(function () { return ref.$lazyInstance$[memberName].apply(ref.$lazyInstance$, args); });
                    }
                });
            }
        });
...
var addEventListeners = function (elm, hostRef, listeners) {
    var removeFns = listeners.map(function (_a) {
        ...
        return function () { return target.removeEventListener(name, handler, opts); };
    });
...
var initializeComponent = function (elm, hostRef, cmpMeta, hmrVersionId, Cstr) { return __awaiter(_this, void 0, void 0, function () {
    var e_2, style_1, scopeId_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!((hostRef.$flags$ & 256 /* hasInitializedComponent */) === 0)) return [3 /*break*/, 7];
            ...
            case 3:
                ...
                return [3 /*break*/, 4];
            case 4:
                if (!(!Cstr.isStyleRegistered && Cstr.style)) return [3 /*break*/, 7];
                style_1 = Cstr.style;
                scopeId_1 = getScopeId(cmpMeta.$tagName$, hostRef.$modeName$);
                if (!(cmpMeta.$flags$ & 8) /* needsShadowDomShim */) return [3 /*break*/, 6]; /* needsShadowDomShim */
                return [4 /*yield*/, import('./chunk-c152be33.js').then(function (m) { return m.scopeCss(style_1, scopeId_1, false); })];
            case 5:
                style_1 = _a.sent();
                _a.label = 6;
            case 6:
            ...
            case 7:
                ...
                if (hostRef.$ancestorComponent$ && !hostRef.$ancestorComponent$['s-lr']) {
                    // this is the intial load and this component it has an ancestor component
                    // but the ancestor component has NOT fired its will update lifecycle yet
                    // so let's just cool our jets and wait for the ancestor to continue first
                    hostRef.$ancestorComponent$['s-rc'].push(function () {
...
var patchBrowser = function () { return __awaiter(_this, void 0, void 0, function () {
    var scriptElm, resourcesUrl;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                scriptElm = Array.from(doc.querySelectorAll('script')).find(function (a) { return a.src.includes(NAMESPACE); });
                resourcesUrl = new URL('.', new URL(scriptElm ? scriptElm.src : '', doc.baseURI));
                patchDynamicImport(resourcesUrl.href);
                if (!!window.customElements) return [3 /*break*/, 2];
                // @ts-ignore
                return [4 /*yield*/, import('./chunk-1aaed225.js')];
            case 1:
                // @ts-ignore
                _a.sent();
                _a.label = 2;
            case 2: return [2 /*return*/, resourcesUrl.pathname];
        }
    });
}); };
...
export { patchBrowser as a, bootstrapLazy as b, h as c, registerInstance as d, createEvent as e, getAssetPath as f, getElement as g, Host as h };
