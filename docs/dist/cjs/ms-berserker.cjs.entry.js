...
const BerserkerSkills = /*#__PURE__*/Object.freeze({
  DarkAura: DarkAura,
  XSlash: XSlash,
...
class BerserkerComponent {
    ...
    componentWillLoad() {
        __chunk_2.processSkills(this, BerserkerSkills);
    }
    async getData() {
        return __chunk_2.toSkillChangeEventObject(this, BerserkerSkills);
    }
    ...
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_2.toSkillChangeEventObject(this, BerserkerSkills));
    }
    render() {
