...
class ThiefComponent {
    ...
    componentWillLoad() {
        __chunk_2.processSkills(this, ThiefSkills);
    }
    async getData() {
        return __chunk_2.toSkillChangeEventObject(this, ThiefSkills);
    }
    levelChanged(skill, level) {
        this[skill.prop] = level;
        __chunk_2.processSkills(this, ThiefSkills, skill);
        this.emitChangeEvent();
    }
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_2.toSkillChangeEventObject(this, ThiefSkills));
    }
    render() {
        return (__chunk_1.h("ms-chart", { msClass: "thief" }, __chunk_2.renderLevelControls(this, ThiefSkills, this.editable, this.extras)));
    }
...
exports.ms_thief = ThiefComponent;
