...
class StrikerComponent {
    ...
    componentWillLoad() {
        __chunk_2.processSkills(this, StrikerSkills);
    }
    async getData() {
        return __chunk_2.toSkillChangeEventObject(this, StrikerSkills);
    }
    ...
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_2.toSkillChangeEventObject(this, StrikerSkills));
    }
    render() {
