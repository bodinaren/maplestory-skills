...
class PriestComponent {
    ...
    componentWillLoad() {
        __chunk_3.processSkills(this, PriestSkills, this.ignoreMax);
    }
    async getData() {
        return __chunk_3.toSkillChangeEventObject(this, PriestSkills);
    }
    levelChanged(skill, level) {
        this[skill.prop] = level;
        __chunk_3.processSkills(this, PriestSkills, this.ignoreMax, skill);
    ...
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_3.toSkillChangeEventObject(this, PriestSkills));
    }
    render() {
        return (__chunk_1.h("ms-chart", { msClass: "priest", rank: this.rank, onRankChange: ({ detail }) => this.rank = detail }, __chunk_3.renderLevelControls(this, RankOneSkills, this.editable, this.extras, __chunk_2.Rank.Basic), __chunk_3.renderLevelControls(this, RankTwoSkills, this.editable, this.extras, __chunk_2.Rank.Awakening)));
    }
