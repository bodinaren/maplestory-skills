...
class RunebladeComponent {
    ...
    async getData() {
        return __chunk_3.toSkillChangeEventObject(this, RunebladeSkills);
    }
    ...
    render() {
        return ([
            __chunk_1.h("ms-chart", { msClass: "runeblade", rank: this.rank, onRankChange: ({ detail }) => this.rank = detail }, __chunk_3.renderLevelControls(this, this.rankOneSkills, this.editable, this.extras, __chunk_2.Rank.Basic, {
                onSkillclicked: (evt) => this.changeSigil(evt.detail),
            }), __chunk_3.renderLevelControls(this, this.rankTwoSkills, this.editable, this.extras, __chunk_2.Rank.Awakening, {
                onSkillclicked: (evt) => this.changeSigil(evt.detail),
            }))
        ]);
    }
    ...
    static getStyles() {
        return `
      ms-runeblade[extras] ms-skill:before { background: url(${__chunk_4.getOptimizedAssetPath(`assets/skill-shield-selected.png`)}) }
      :host([extras]) ms-skill:before { background: url(${__chunk_4.getOptimizedAssetPath(`assets/skill-shield-selected.png`)}) }
    `;
    }
...
__decorate([
    __chunk_4.ConstructibleStyle({ cacheKeyProperty: "extras" })
], RunebladeComponent.prototype, "styles", void 0);

exports.ms_runeblade = RunebladeComponent;
