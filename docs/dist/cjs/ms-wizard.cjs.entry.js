...
const WizardSkills = /*#__PURE__*/Object.freeze({
  ManaFont: ManaFont,
  Teleport: Teleport,
...
class WizardComponent {
    ...
    componentWillLoad() {
        __chunk_2.processSkills(this, WizardSkills);
    }
    async getData() {
        return __chunk_2.toSkillChangeEventObject(this, WizardSkills);
    }
    levelChanged(skill, level) {
        this[skill.prop] = level;
        __chunk_2.processSkills(this, WizardSkills, skill);
        this.emitChangeEvent();
    }
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_2.toSkillChangeEventObject(this, WizardSkills));
    }
    render() {
        return (__chunk_1.h("ms-chart", { msClass: "wizard" }, __chunk_2.renderLevelControls(this, WizardSkills, this.editable, this.extras)));
    }
...
exports.ms_wizard = WizardComponent;
