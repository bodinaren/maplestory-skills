...
const WizardSkills = Object.assign({}, RankOneSkills, RankTwoSkills);
...
class WizardComponent {
    ...
    render() {
        return (__chunk_1.h("ms-chart", { msClass: "wizard", rank: this.rank, onRankChange: ({ detail }) => this.rank = detail }, __chunk_3.renderLevelControls(this, RankOneSkills, this.editable, this.extras, __chunk_2.Rank.Basic), __chunk_3.renderLevelControls(this, RankTwoSkills, this.editable, this.extras, __chunk_2.Rank.Awakening)));
    }
