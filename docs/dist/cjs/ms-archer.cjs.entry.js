...
class ArcherComponent {
    ...
    componentWillLoad() {
        __chunk_2.processSkills(this, ArcherSkills);
    }
    async getData() {
        return __chunk_2.toSkillChangeEventObject(this, ArcherSkills);
    }
    levelChanged(skill, level) {
        this[skill.prop] = level;
        __chunk_2.processSkills(this, ArcherSkills, skill);
        this.emitChangeEvent();
    }
    emitChangeEvent() {
        this.onSkillChanged.emit(__chunk_2.toSkillChangeEventObject(this, ArcherSkills));
    }
    render() {
        return [
            __chunk_1.h("ms-chart", { msClass: "archer" }, __chunk_2.renderLevelControls(this, ArcherSkills, this.editable, this.extras))
        ];
    }
