...
class ChartComponent {
    ...
    static getStyles(msClass) {
      ...
      .chart {
        background-image: url(${__chunk_1.getAssetPath(`assets/charts/chart.jpg`)});
      }
      .class-icon {
...
__decorate([
    __chunk_3.ConstructibleStyle({ cacheKeyProperty: "msClass" })
...
class SkillOverlayComponent {
    ...
    render() {
        ...
        return (__chunk_1.h("div", null, __chunk_1.h("h1", { class: this.skill.element, style: this.skill.element && {
            ...
            || __chunk_1.h("slot", { name: "icon" })), __chunk_1.h("div", { class: "infoAndLevel" }, __chunk_1.h("div", { class: "shortInfo" }, this.spirit && `Spirit ${this.spirit}`, this.spirit && this.cooldown && ` / `, this.cooldown && `Cooldown: ${this.cooldown} Sec`), __chunk_1.h("div", { class: "level" }, "Level ", this.level || 1, this.level === this.skill.maxLevel &&
